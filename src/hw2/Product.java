...
public class Product {
	...
	private Map<String, ProductNutrient> productNutrients = new HashMap<>();
	...
	public final void setProductNutrients(Map<String, ProductNutrient> productNutrients) {
	...
	public final Map<String, ProductNutrient> getProductNutrients() {
