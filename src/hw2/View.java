...
public class View {
	BorderPane root = new BorderPane(); // this holds the menu at the top and welcome scene or nutriTrackerPane in the
										// center region.

	BorderPane nutriTrackerPane = new BorderPane(); // holds the nutriProfilerGrid in the top region. More components
													// will be added to it in NutriByte 3.0
	...
	void initializePrompts() {
		...
		ObservableList<String> physicalActivityOptions = FXCollections.observableArrayList(
